...
\begingroup
    ...
    \begin{thebibliography}{9}
        \bibitem{dma} J. D. Ullman (1990). \emph{Principles of Database \& Knowledge-Base Systems: Classical Database Systems Vol. 1}. Computer Science Press
    \end{thebibliography}
\endgroup

\begin{tcolorbox}[colback=Dandelion!25, colframe=Dandelion!50]
    \begin{center}
        The "\textit{Data Management and Analysis Unit 1}" course was taught in the winter semester in 2024 by prof. Giuseppe Perelli (\href{mailto:perelli@di.uniroma1.it}{\texttt{perelli@di.uniroma1.it}})
    \end{center}
\end{tcolorbox}
