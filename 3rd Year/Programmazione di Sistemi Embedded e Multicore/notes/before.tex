...
\begingroup
    ...
    \begin{thebibliography}{9}
        \bibitem{pem1} Peter Pacheco, Matthew Malensek. (2021). \emph{An Introduction to Parallel Programming (Second Edition)}. Morgan Kaufmann
        
        \bibitem{pem2} David B. Kirk, Wen-mei W. Hwu. (2017). \emph{Programming Massively Parallel Processors (Third Edition)}. Morgan Kaufmann

        \bibitem{pem3} Gerassimos Barlas. (2022). \emph{Multicore and GPU Programming (Second Edition)}. Morgan Kaufmann
    \end{thebibliography}
\endgroup
