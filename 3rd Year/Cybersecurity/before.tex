...
\begingroup
    ...
    \begin{thebibliography}{9}
        \bibitem{cyb1} William Stallings, Lawrie Brown. (2018). \emph{Computer Security Principles and Practice (Fourth Edition)}. Pearson
    \end{thebibliography}
\endgroup

\begin{tcolorbox}[colback=Dandelion!25, colframe=Dandelion!50]
    \begin{center}
        The "\textit{Cybersecurity}" course was taught in the Winter semester in 2024 by prof. Angelo Spognardi (\href{mailto:spognardi@di.uniroma1.it}{\texttt{spognardi@di.uniroma1.it}})
    \end{center}
\end{tcolorbox}
